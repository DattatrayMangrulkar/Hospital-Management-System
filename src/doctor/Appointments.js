                                    ...
                                    appointments.map((appointment) => {
                                        return <tr key={appointment.id}>
                                            ...
                                            <td>
                                                ...
                                                {
                                                    appointment.status=="ATTENDED" || appointment.status=="CANCELLED" || appointment.status=="CONFIRMED" || appointment.status=="ATTENDED_AND_BILL_GENERATED"?"-" :<input type={"button"} value={"Confirm"} className='btn btn-primary' onClick={()=>{
                                                ...
                                                {"  "}
                                                {
                                                    appointment.status=="ATTENDED" || appointment.status=="CANCELLED" || appointment.status=="ATTENDED_AND_BILL_GENERATED" ?"-" :<input type={"button"} value={"Cancel"} className='btn btn-danger' onClick={()=>{
